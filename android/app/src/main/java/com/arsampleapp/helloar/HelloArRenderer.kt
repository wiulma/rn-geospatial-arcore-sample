...
import com.arsampleapp.common.helpers.DisplayRotationHelper
import com.arsampleapp.common.helpers.TrackingStateHelper
import com.arsampleapp.common.samplerender.Framebuffer
import com.arsampleapp.common.samplerender.GLError
import com.arsampleapp.common.samplerender.Mesh
import com.arsampleapp.common.samplerender.SampleRender
import com.arsampleapp.common.samplerender.Shader
import com.arsampleapp.common.samplerender.Texture
import com.arsampleapp.common.samplerender.VertexBuffer
import com.arsampleapp.common.samplerender.arcore.BackgroundRenderer
import com.arsampleapp.common.samplerender.arcore.PlaneRenderer
import com.arsampleapp.common.samplerender.arcore.SpecularCubemapFilter
...
class HelloArRenderer(val activity: HelloArActivity) :
  ...
  private fun handleTap(frame: Frame, camera: Camera) {
    ...
    if (firstHitResult != null) {
      ...
      //TODO: replace anchor with geo anchor
      wrappedAnchors.add(WrappedAnchor(firstHitResult.createAnchor(), firstHitResult.trackable))
/*
      this.activity.fusedLocationClient.lastLocation
        .addOnSuccessListener { location : Location? ->
          // Got last known location. In some rare situations this can be null.
          val msg = "current location = " + location?.latitude.toString() + ", " + location?.longitude.toString() + ", " + location?.altitude.toString()
          Log.d(TAG, msg)
          // current location = 45.5561922, 12.0734032, 53.900001525878906
          ...
          earthAnchor =
            earth?.createAnchor(location!!.latitude, location!!.longitude, location!!.altitude, qx, qy, qz, qw)

          //TODO: replace anchor with geo anchor
          wrappedAnchors.add(WrappedAnchor(earthAnchor!!, firstHitResult!!.trackable))
          val a = ""
        }
      */
...
/*
  private suspend fun getCurrentUserLocation() = suspendCoroutine<Location?> { result ->
    if (ActivityCompat.checkSelfPermission(
        this.activity,
        Manifest.permission.ACCESS_FINE_LOCATION
      ) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(
    ...
    this.activity.fusedLocationClient.getCurrentLocation(
      ...
      .addOnSuccessListener {
        ...
        val msg = "current location = " + it?.latitude.toString() + ", " + it?.longitude.toString() + ", " + it?.altitude.toString()
        Log.d(TAG, msg)
        result.resume(it)
      }
  }
